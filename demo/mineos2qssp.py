...
with open(fname,'r') as f:
    ...
    for i,line in enumerate(d):
        if i <= 2:
            ...
            # if i % 1000 == 0:
            # Mineos: radius [m], rho [kg/m^3], vpv [m/s] vsv [m/s] qka , qmu, vph, vsh 
    ...
    for i in range(nlayers):
        ii += 1
        qp = 1.0e8
        if stdata[nlayers-i-1][5] == 0.0:
            qs = 0.0
        else:
            qs = 1.0e8
        tmp = '{:>4} {:>9.4f} {:>10.5f} {:>10.5f} {:>10.5f} {:>10.5e} {:>10.5e}'.format(ii, 6371.0 - stdata[nlayers-i-1][0]/1000.0, stdata[nlayers-i-1][2]/1000.0, stdata[nlayers-i-1][3]/1000.0, stdata[nlayers-i-1][1]/1000.0, qp, qs)
        f2.write(tmp+'\n')       
